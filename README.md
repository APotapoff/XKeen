...
* Quad9 DoH: `9.9.9.9` `dns.quad9.net`; `149.112.112.112` `dns.quad9.net`
...
> *После обновления Xray для корректной работы XKeen необходимо удалить файл **transport.json** из директории **opkg\etc\xray\con***REMOVED***gs** и добавить строку в верхнюю часть файла **05_routing.json**: `"domainStrategy": "IPIfNonMatch",`*
