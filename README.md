*XKeen обновлён до версии 1.1.3.9 (04 февраля 2026) — форк от [JamesZero](https://github.com/jameszeroX).*

<details>
<summary>Сравнение форка с оригинальным XKeen:</summary>
...
<details>
<summary>Форк XKeen версии 1.1.3.9 — список изменений</summary>
...
> *Используйте комкнду `xkeen -ipv6` чтобы отключить/включить протокол IPv6 в KeeneticOS 5+*
