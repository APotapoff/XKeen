*XKeen обновлён до версии 1.1.3.4 (22.04.2025) — форк от [JamesZero](https://github.com/jameszeroX).*
...
4. После внесения всех изменений перезагрузите сервис XKeen, чтобы новые настройки вступили в силу. Для этого выполните следующую команду:
