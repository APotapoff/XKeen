...
> *При возникновении ошибки <mark>«panic: runtime error: slice bounds out of range»</mark> [обновите ядро xray](https://github.com/Corvus-Malus/XKeen?tab=readme-ov-***REMOVED***le#обновление-ядра-xray-до-последней-версии)*
