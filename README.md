...
> *После обновления Xray для корректной работы XKeen необходимо удалить файл **02_transport.json** из директории **opkg\etc\xray\con***REMOVED***gs** и добавить строку в верхнюю часть файла **05_routing.json**: `"domainStrategy": "IPIfNonMatch",`*
